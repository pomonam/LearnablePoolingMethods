...
def main():
    ...
    inference_command += "--train_dir=/home/deeptopology2/JuhanTestModelV2-1 "
    inference_command += "--base_learning_rate={} ".format(str(BASE_LEARNING_RATE))
    inference_command += "--output_file=/home/deeptopology2/predictions.csv ".format(MODEL_NAME + str(MODEL_VERSION))
