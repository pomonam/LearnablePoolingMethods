...
# Transformer #################################################################
###############################################################################
flags.DEFINE_integer("fish14_iteration", 128,
                     "Number of frames per batch")
flags.DEFINE_integer("fish14_video_cluster_size", 256,
                     "Video clustering size")
flags.DEFINE_integer("fish14_audio_cluster_size", 32,
                     "Audio clustering size")
flags.DEFINE_integer("fish14_filter_size", 2,
                     "Video clustering size")
...
flags.DEFINE_integer("fish12_video_cluster_size", 256,
                     "Video clustering size")
flags.DEFINE_integer("fish12_audio_cluster_size", 32,
                     "Audio clustering size")
flags.DEFINE_integer("fish12_filter_size", 2,
                     "Video clustering size")
flags.DEFINE_integer("fish12_hidden_size", 1024,
                     "Hidden size")
flags.DEFINE_bool("fish12_shift_operation", True,
                  "Perform shift operation?")
flags.DEFINE_float("fish12_cluster_dropout", 0.7,
                   "Dropout rate for clustering operation")
flags.DEFINE_float("fish12_ff_dropout", 0.8,
                   "Dropout rate for Feed Forward operation")
flags.DEFINE_float("fish12_linear_proj_dropout", 0.8,
                   "Dropout rate for linear projection")
flags.DEFINE_float("fish12_l2_regularization_rate", 1e-8,
                   "Regularization rate")
...
class CrazyFishV12(models.BaseModel):
    def create_model(self,
                     ...
                     is_training=True,
                     **unused_params):
        iterations = iterations or FLAGS.fish12_iteration
        video_cluster_size = FLAGS.fish12_video_cluster_size
        audio_cluster_size = FLAGS.fish12_audio_cluster_size
        shift_operation = FLAGS.fish12_shift_operation
        cluster_dropout = FLAGS.fish12_cluster_dropout
        ff_dropout = FLAGS.fish12_ff_dropout
        linear_dropout = FLAGS.fish12_linear_proj_dropout
        filter_size = FLAGS.fish12_filter_size
        l2_reg_rate = FLAGS.fish12_l2_regularization_rate
        hidden_size = FLAGS.fish12_hidden_size
...
flags.DEFINE_integer("fish11_iteration", 128,
                     "Number of frames per batch")
flags.DEFINE_integer("fish11_video_cluster_size", 256,
                     "Video clustering size")
flags.DEFINE_integer("fish11_audio_cluster_size", 32,
                     "Audio clustering size")
flags.DEFINE_integer("fish11_filter_size", 2,
                     "Video clustering size")
flags.DEFINE_integer("fish11_hidden_size", 1024,
                     "Hidden size")
flags.DEFINE_bool("fish11_shift_operation", True,
                  "Perform shift operation?")
flags.DEFINE_float("fish11_cluster_dropout", 0.7,
                   "Dropout rate for clustering operation")
flags.DEFINE_float("fish11_ff_dropout", 0.8,
                   "Dropout rate for Feed Forward operation")
flags.DEFINE_float("fish11_linear_proj_dropout", 0.8,
                   "Dropout rate for linear projection")
flags.DEFINE_float("fish11_l2_regularization_rate", 1e-8,
                   "Regularization rate")
...
class CrazyFishV11(models.BaseModel):
    def create_model(self,
                     ...
                     is_training=True,
                     **unused_params):
        iterations = iterations or FLAGS.fish11_iteration
        video_cluster_size = FLAGS.fish11_video_cluster_size
        audio_cluster_size = FLAGS.fish11_audio_cluster_size
        shift_operation = FLAGS.fish11_shift_operation
        cluster_dropout = FLAGS.fish11_cluster_dropout
        ff_dropout = FLAGS.fish11_ff_dropout
        linear_dropout = FLAGS.fish11_linear_proj_dropout
        filter_size = FLAGS.fish11_filter_size
        l2_reg_rate = FLAGS.fish11_l2_regularization_rate
        hidden_size = FLAGS.fish11_hidden_size
...
flags.DEFINE_integer("fish10_iteration", 128,
                     "Number of frames per batch")
flags.DEFINE_integer("fish10_video_cluster_size", 256,
                     "Video clustering size")
flags.DEFINE_integer("fish10_audio_cluster_size", 32,
                     "Audio clustering size")
flags.DEFINE_integer("fish10_filter_size", 2,
                     "Video clustering size")
flags.DEFINE_integer("fish10_hidden_size", 1024,
                     "Hidden size")
flags.DEFINE_bool("fish10_shift_operation", True,
                  "Perform shift operation?")
flags.DEFINE_float("fish10_cluster_dropout", 0.7,
                   "Dropout rate for clustering operation")
flags.DEFINE_float("fish10_ff_dropout", 0.8,
                   "Dropout rate for Feed Forward operation")
flags.DEFINE_float("fish10_linear_proj_dropout", 0.8,
                   "Dropout rate for linear projection")
flags.DEFINE_float("fish10_l2_regularization_rate", 1e-8,
                   "Regularization rate")


class CrazyFishV10(models.BaseModel):
    def create_model(self,
                     model_input,
                     vocab_size,
                     num_frames,
                     ...
                     is_training=True,
                     **unused_params):
        iterations = iterations or FLAGS.fish10_iteration
        video_cluster_size = FLAGS.fish10_video_cluster_size
        audio_cluster_size = FLAGS.fish10_audio_cluster_size
        shift_operation = FLAGS.fish10_shift_operation
        cluster_dropout = FLAGS.fish10_cluster_dropout
        ff_dropout = FLAGS.fish10_ff_dropout
        linear_dropout = FLAGS.fish10_linear_proj_dropout
        filter_size = FLAGS.fish10_filter_size
        l2_reg_rate = FLAGS.fish10_l2_regularization_rate
        hidden_size = FLAGS.fish10_hidden_size
...
flags.DEFINE_integer("fish9_video_cluster_size", 256,
                     "Video clustering size")
flags.DEFINE_integer("fish9_audio_cluster_size", 32,
                     "Audio clustering size")
flags.DEFINE_integer("fish9_filter_size", 2,
                     "Video clustering size")
flags.DEFINE_integer("fish9_hidden_size", 1024,
                     "Hidden size")
flags.DEFINE_bool("fish9_shift_operation", True,
                  "Perform shift operation?")
flags.DEFINE_float("fish9_cluster_dropout", 0.7,
                   "Dropout rate for clustering operation")
flags.DEFINE_float("fish9_ff_dropout", 0.8,
                   "Dropout rate for Feed Forward operation")
flags.DEFINE_float("fish9_linear_proj_dropout", 0.8,
                   "Dropout rate for linear projection")
flags.DEFINE_float("fish9_l2_regularization_rate", 1e-8,
                   "Regularization rate")


class CrazyFishV9(models.BaseModel):
    def create_model(self,
                     model_input,
                     vocab_size,
                     num_frames,
                     ...
                     is_training=True,
                     **unused_params):
        iterations = iterations or FLAGS.fish9_iteration
        video_cluster_size = FLAGS.fish9_video_cluster_size
        audio_cluster_size = FLAGS.fish9_audio_cluster_size
        shift_operation = FLAGS.fish9_shift_operation
        cluster_dropout = FLAGS.fish9_cluster_dropout
        ff_dropout = FLAGS.fish9_ff_dropout
        linear_dropout = FLAGS.fish9_linear_proj_dropout
        filter_size = FLAGS.fish9_filter_size
        l2_reg_rate = FLAGS.fish9_l2_regularization_rate
        hidden_size = FLAGS.fish9_hidden_size
...
flags.DEFINE_integer("fish8_iteration", 128,
                     "Number of frames per batch")
flags.DEFINE_integer("fish8_video_cluster_size", 256,
                     "Video clustering size")
flags.DEFINE_integer("fish8_audio_cluster_size", 32,
                     "Audio clustering size")
flags.DEFINE_integer("fish8_filter_size", 2,
                     "Video clustering size")
flags.DEFINE_integer("fish8_hidden_size", 1024,
                     "Hidden size")
flags.DEFINE_bool("fish8_shift_operation", True,
                  "Perform shift operation?")
flags.DEFINE_float("fish8_cluster_dropout", 0.7,
                   "Dropout rate for clustering operation")
flags.DEFINE_float("fish8_ff_dropout", 0.8,
                   "Dropout rate for Feed Forward operation")
flags.DEFINE_float("fish8_linear_proj_dropout", 0.8,
                   "Dropout rate for linear projection")
flags.DEFINE_float("fish8_l2_regularization_rate", 1e-8,
                   "Regularization rate")


class CrazyFishV8(models.BaseModel):
    def create_model(self,
                     model_input,
                     vocab_size,
                     num_frames,
                     ...
                     is_training=True,
                     **unused_params):
        iterations = iterations or FLAGS.fish8_iteration
        video_cluster_size = FLAGS.fish8_video_cluster_size
        audio_cluster_size = FLAGS.fish8_audio_cluster_size
        shift_operation = FLAGS.fish8_shift_operation
        cluster_dropout = FLAGS.fish8_cluster_dropout
        ff_dropout = FLAGS.fish8_ff_dropout
        linear_dropout = FLAGS.fish8_linear_proj_dropout
        filter_size = FLAGS.fish8_filter_size
        l2_reg_rate = FLAGS.fish8_l2_regularization_rate
        hidden_size = FLAGS.fish8_hidden_size
...
class CrazyFishV7(models.BaseModel):
    def create_model(self,
        ...
        with tf.variable_scope("video"):
            with tf.variable_scope("cluster"):
                video_cluster_activation = video_cluster.forward(video_features)
                video_bottleneck = tf.layers.dense(video_cluster_activation, 1024 / hidden_size,
                                                   use_bias=False, activation=None)
                video_bottleneck = tf.layers.batch_normalization(video_bottleneck, training=is_training)
        ...
        with tf.variable_scope("audio"):
            with tf.variable_scope("cluster"):
                audio_cluster_activation = audio_cluster.forward(audio_features)
                audio_bottleneck = tf.layers.dense(audio_cluster_activation, 128 / hidden_size,
                                                   use_bias=False, activation=None)
                audio_bottleneck = tf.layers.batch_normalization(audio_bottleneck, training=is_training)
...
flags.DEFINE_integer("fish6_video_cluster_size", 256,
                     "Video clustering size")
flags.DEFINE_integer("fish6_audio_cluster_size", 32,
                     "Audio clustering size")
flags.DEFINE_integer("fish6_filter_size", 2,
                     "Video clustering size")
flags.DEFINE_integer("fish6_hidden_size", 1024,
                     "Hidden size")
flags.DEFINE_bool("fish6_shift_operation", True,
                  "Perform shift operation?")
flags.DEFINE_float("fish6_cluster_dropout", 0.7,
                   "Dropout rate for clustering operation")
flags.DEFINE_float("fish6_ff_dropout", 0.8,
                   "Dropout rate for Feed Forward operation")
flags.DEFINE_float("fish6_linear_proj_dropout", 0.8,
                   "Dropout rate for linear projection")
flags.DEFINE_float("fish6_l2_regularization_rate", 1e-8,
                   "Regularization rate")
...
flags.DEFINE_integer("fish5_iteration", 128,
                     "Number of frames per batch")
flags.DEFINE_integer("fish5_video_cluster_size", 256,
                     "Video clustering size")
flags.DEFINE_integer("fish5_audio_cluster_size", 32,
                     "Audio clustering size")
flags.DEFINE_integer("fish5_filter_size", 2,
                     "Video clustering size")
flags.DEFINE_integer("fish5_hidden_size", 1024,
                     "Hidden size")
flags.DEFINE_bool("fish5_shift_operation", True,
                  "Perform shift operation?")
flags.DEFINE_float("fish5_cluster_dropout", 0.7,
                   "Dropout rate for clustering operation")
flags.DEFINE_float("fish5_ff_dropout", 0.8,
                   "Dropout rate for Feed Forward operation")
flags.DEFINE_float("fish5_linear_proj_dropout", 0.8,
                   "Dropout rate for linear projection")
flags.DEFINE_float("fish5_l2_regularization_rate", 1e-8,
                   "Regularization rate")
...
class CrazyFishV5(models.BaseModel):
    def create_model(self,
                     ...
                     is_training=True,
                     **unused_params):
        iterations = iterations or FLAGS.fish5_iteration
        video_cluster_size = FLAGS.fish5_video_cluster_size
        audio_cluster_size = FLAGS.fish5_audio_cluster_size
        shift_operation = FLAGS.fish5_shift_operation
        cluster_dropout = FLAGS.fish5_cluster_dropout
        ff_dropout = FLAGS.fish5_ff_dropout
        linear_dropout = FLAGS.fish5_linear_proj_dropout
        ...
        with tf.variable_scope("video"):
            with tf.variable_scope("cluster"):
                video_activation = video_cluster.forward(video_features)
                video_activation = tf.reshape(video_activation, [-1, 1024, video_cluster_size])
                # -> batch_size x 1024 x cluster_size
                video_activation = tf.transpose(video_activation, perm=[0, 2, 1])
                # -> batch_size x cluster_size x 1024
                point_wise_cnn_weights = tf.get_variable("pointwise_cnn_weights",
                                                         [video_cluster_size, video_kernel_size, 1024])
                tp_point_wise_cnn_weights = tf.transpose(point_wise_cnn_weights, perm=[0, 2, 1])
                # -> cluster_size x 1024 x kernel_size
                tp_video_activation = tf.transpose(video_activation, perm=[1, 0, 2])
                # -> cluster_size x batch_size x 1024
                video_activation = tf.matmul(tp_video_activation, tp_point_wise_cnn_weights)
                # -> cluster_size x batch_size x kernel_size
        ...
        with tf.variable_scope("audio"):
            with tf.variable_scope("cluster"):
                audio_activation = audio_cluster.forward(audio_features)
                audio_activation = tf.reshape(audio_activation, [-1, 128, audio_cluster_size])
                # -> batch_size x 128 x cluster_size
                audio_activation = tf.transpose(audio_activation, perm=[0, 2, 1])
                # -> batch_size x cluster_size x 128
                point_wise_cnn_weights = tf.get_variable("pointwise_cnn_weights",
                                                         [audio_cluster_size, audio_kernel_size, 128])
                tp_point_wise_cnn_weights = tf.transpose(point_wise_cnn_weights, perm=[0, 2, 1])
                # -> cluster_size x 128 x kernel_size
                tp_audio_activation = tf.transpose(audio_activation, perm=[1, 0, 2])
                # -> cluster_size x batch_size x 128
                audio_activation = tf.matmul(tp_audio_activation, tp_point_wise_cnn_weights)
                # -> cluster_size x batch_size x kernel_size
